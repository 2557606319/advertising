...
public class JwtTokenUtil {
    ...
    /**
     * 从httprequest header 获取token中的 客户端用户id
     * @return
     */
    public static Long getClientUserIdFromToken() {
        return Long.valueOf(getClaimFromToken(HttpKit.getRequest().getHeader(JwtConstants.AUTH_HEADER)).getSubject());
    }
